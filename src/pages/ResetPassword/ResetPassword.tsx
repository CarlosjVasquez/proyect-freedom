...
const ResetPassword: React.FC<UserDetailPageProps> = ({match, history}) => {
    ...
    const [errorPasswordSimilar, setErrorPasswordSimilar] = useState<boolean>(false)
            ...
            <LayoutFirst>
                ...
                <IonRow>
                    <IonCol>
                        ...
                        <IonRow>
                          <IonCol>
                            <BtnPrimary disabled={!passwordValidate} name="Send" onClickHandle={() => passwordValidate && changePassword()} />
                          </IonCol>
                        </IonRow>
                    </IonCol>
                    <Toast active={confirmChangePassword} duration={1500} confirm={true} message="Change Succesfull" />
                    <Toast active={errorTokenExpired} duration={1500} message="This Token Expired" />
                    <Toast active={errorPasswordSimilar} duration={1500} message="The password is too similar to the first name" />
